        ...
        <footer class="ed-float-cart__footer">
            ...
            <?php if ($cart && !$cart->is_empty()) : ?>
                ...
                <div class="bottom-cart">
                    ...
                    <div class="cart-custom-notice"><?php _e('*The final price will be set after weighing.', 'deliz-short'); ?>
                        <a href="javascript:void(0);"><?php _e('More Details', 'deliz-short'); ?></a></div>
