...
<?php
  ...
  $site_logo        = function_exists('get_field') ? trim((string) get_field('site_logo', 'option')) : '';
  $site_mobile_logo = function_exists('get_field') ? trim((string) get_field('site_mobile_logo', 'option')) : '';
?>
     ...
     <nav class="site-nav" aria-label="<?php esc_attr_e('Primary', 'deliz-short'); ?>">
      ...
      <a href="<?php echo esc_url(home_url('/')); ?>" class="site-logo" rel="home">
          <?php if ($site_logo !== '') : ?>
              ...
              <?php if ($site_mobile_logo !== '') : ?>
                  <img
                      class="site-logo__img site-logo__img--mobile"
                      src="<?php echo esc_url($site_mobile_logo); ?>"
                      alt="<?php echo esc_attr(get_bloginfo('name')); ?>"
                  >
              <?php endif; ?>

          <?php else : ?>
              <span class="site-logo__fallback<?php echo ($site_mobile_logo !== '' ? ' has-mobile-logo' : ''); ?>">
                  <?php the_custom_logo(); ?>
              </span>
