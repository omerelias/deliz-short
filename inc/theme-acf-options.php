...
add_action('acf/save_post', function ($post_id) {
  ...
  $menu_img_size = get_field('menu_img_size', 'option');   // גודל תמונות בתפריט
  $menu_img_size_mobile = get_field('menu_img_size_mobile', 'option');   // גודל תמונות בתפריט
  ...
  //checkout
  $checkout_background   = get_field('checkout_background', 'option'); //צבע רקע
